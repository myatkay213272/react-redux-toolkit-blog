...
import PostsListWithErrorBoundary from './feactures/posts/PostsListWithErrorBoundary'  // make sure path is correct
  ...
  return (
    <Routes>
      <Route path='/' element={<Layout />}>
        <Route index element={<PostsListWithErrorBoundary />} />
